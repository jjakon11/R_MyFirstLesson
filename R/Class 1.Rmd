...
-   12:00-13:00, every Wednesdays
    -   Course instruction: 30-45 minutes
    -   Practice: 15-30 minutes
-   Instructional materials for each class will be uploaded.
    -   The file would be *.pdf* files.
    -   Make sure to take the note in each class.
    -   I will upload to the [cloud](https://drive.google.com/drive/folders/1SYsiKhNMyCMZmHKOkY6ovJRVLX2s1J5R?usp=drive_link) before the class.
    
          ![](D:/Drive/2_lab/Edu5_Course/Rbasic/Course_Rbasic/Class 1/ClassPic/QRcode.png){width=20%}

-   Exercises after class
    -   Exercises are entirely optional, you have the choice to submit them or not.
    -   Must be submitted in *.rmd* files.
    
- Bibliography

    - [An Introduction to Data Analysis in R](https://drive.google.com/file/d/1Ny44_r2ROyVr3_7Nf9NaygU286KTEU8V/view?usp=drive_link)
  
    - [ggplot2: Elegant graphics for data analysis](https://drive.google.com/file/d/1QGeusCZbuI_VVW98KBQOLnJ4mERWxIJa/view?usp=drive_link)
  
    -  [R for everyone: Advanced Ananlytic and Grraphics 2nd Edition](https://drive.google.com/file/d/1RcE1VGKUAhdKVm0y_QhHAlHfwU32GAOB/view?usp=sharing)


# Class outline

-   9/13 Starting with R: Programming Languages and R data structure
-   9/20 Data structures, importing and exporting
-   9/27 Tidy your data: mutate, select, filter, group_by and summarise
-   10/4 Tidy your data: bind, join data, gather, and spread
-   10/11 Simple statistic with climate data: t-test, anova
-   10/18 Practice: tidy the tea garden data and calculate the biomass
-   10/25 **Project 1: tidy the climate data**
-   11/1 R base graphics
-   11/8 ggplot2 visualizing 1: bar, point, scale, color and theme
-   11/15 ggplot2 visualizing 2:boxplot and histogram
-   11/22 ggplot2 visualizing 3:geographical visualize
-   11/29 leaflet visualizing
-   12/6 statistic visualizing: regression analysis
-   12/13 **Project 2: visualize the climate data**
-   12/20 climate diagram
-   12/27 **Project 3: global climate diagram**

# 1. What is R?
    
  ![](D:/Drive/2_lab/Edu5_Course/Rbasic/Course_Rbasic/Class 1/ClassPic/R.png){width=20%}
...
# 2. Rstudio
  ...
  ![](D:/Drive/2_lab/Edu5_Course/Rbasic/Course_Rbasic/Class 1/ClassPic/Rstudio.png){width=40%}
