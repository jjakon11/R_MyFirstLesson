...
```{r message=FALSE, warning=FALSE}
Excerdt3 <- read.csv("D:/2_lab/Edu5_Course/Rbasic/Course_Rbasic/Class11/Excerdt3.csv")
...
# 2. Into the basic plotting under ggplot() (coninue...)
...
![](D:/2_lab/Edu5_Course/Rbasic/Course_Rbasic/Class11/theme.jpg)
...
```{r  message=FALSE, warning=FALSE, out.width="80%"}
# Export the graph
ggsave(Pointplot2,filename = "Pointplot3_gsave.png",  width = 20, height=10, units="cm", dpi=300)
...
ggexport(Pointplot2, filename = "Pointplot3_gexport.png", width=3800, height=3000, res=800)
```
...
ggexport(gPloting , filename = "gPloting _gexport.png", width=7000, height=6000, res=500)
```
